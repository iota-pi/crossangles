<?php
/* Simple script to send email from bug report form
 */
...
$body = filter_var($data['body'], FILTER_SANITIZE_FULL_SPECIAL_CHARS) .
    "\r\n\r\nAutomated email send from CrossAngles.\r\nSender name: $name\r\n";
if ($email && $body && filter_var($email, FILTER_VALIDATE_EMAIL)) {
    // Important that email has been sanitised
    mail('crossangles@my.campusbiblestudy.org', 'CrossAngles Contact Form', $body, 'From: no-reply@my.campusbiblestudy.com' . "\r\n" . 'Reply-To: ' . $email);
}
