...
import { ClearNoticeAction, CLEAR_NOTICE, UPDATE_SESSION_MANAGER, SessionManagerAction, UPDATE_SUGGESTED_TIMETABLE, SuggestionAction, CourseListAction, SET_COURSE_DATA } from '../actions';
      ...
      map: [
        [
          "RING1379~LEC~0",
          {
            ...
            offset: { x: 0, y: 0 },
            touched: false,
            session: { course: "RING1379", day: 'F', start: 9, end: 10, index: 0, stream: ""},
          },
        ],
        [
          "RING9731~TUT~0",
          {
            ...
            offset: { x: 0, y: 0 },
            touched: false,
            session: { course: "RING9731", day: 'M', start: 9, end: 10, index: 0, stream: ""},
          },
        ],
      ],
