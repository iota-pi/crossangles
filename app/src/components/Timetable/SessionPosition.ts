...
export function getClashOffset(clashDepth: number) {
  return {
...
export function getRaisedOffset(isRaised: boolean) {
  return {
...
export function getZ(isSnapped: boolean, isDragging: boolean, clashDepth: number) {
